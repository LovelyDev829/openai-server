...
2. Swap-related: Provide swap-related outputs in the format 'swap [from_token]: [from_amount], [to_token], [to_amount]'. If amounts are not specified, use '0' as a placeholder.
 for example "swap SOL: 1, ETH, 0"
3. Trending: to fetch recent trending data. Format the response as a table. answer, "trending, [number of display]"
